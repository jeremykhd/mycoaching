...
const { getExerciseById, getExerciseHistory } = useExerciseService()
...
// Last session data (group sets by session)
...
// Progression data — weight over time for mini chart (last 8 sessions)
